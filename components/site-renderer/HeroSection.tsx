...
export function HeroSection({
  ...
  return (
    <section id="top" className="relative overflow-hidden border-b border-border/60">
      ...
      <div
        className={`${SECTION_CONTAINER} grid gap-12 py-16 sm:py-20 lg:grid-cols-2 lg:items-center lg:gap-16 lg:py-28`}
      >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            {section.secondaryCta ? (
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 w-full rounded-2xl border-border/80 px-8 text-base sm:w-auto"
              >
            ...
            <div className="flex flex-wrap gap-2.5 pt-1">
              {badges.map((item, i) => (
                <Badge
                  key={i}
                  variant="muted"
                  className="gap-2 rounded-full border border-border/60 bg-card/90 px-4 py-2 text-sm font-medium leading-snug"
                >
          ...
          <div className="overflow-hidden rounded-[1.35rem] bg-card/95 backdrop-blur-sm">
            {section.imageUrl ? (
              ...
              <VisualPlaceholder
                ...
                label="Hero visual"
                aspectClass="aspect-[4/3] min-h-[300px] sm:min-h-[340px]"
